//  主调用函数是 setdatetime(this,[object])和setday(this)，[object]是控件输出的控件名，举两个例子：
//  一、<input name=txt><input type=button value=setday onclick="setdatetime(this,document.all.txt)">
//  二、<input onfocus="setdatetime(this)">
var bMoveable=true;
var strFrame;  
document.writeln('<iframe id=endDateLayer frameborder=0 width=168 height=210 bgcolor="#F7F7F7" style="position: absolute;  z-index: 9998; display: none"></iframe>');
strFrame='<style>';
...
strFrame+='<table border=0 cellspacing=1 cellpadding=0 width=168 height=210 bordercolor=#63A3E9 bgcolor=#CADEFF >';
...
strFrame+='    <table border=0 cellspacing=0 cellpadding=2 BORDERCOLORLIGHT=#63A3E9 BORDERCOLORDARK=#FFFFFF bgcolor=#ffffff width=166 height=140 >';
...
strFrame+='        <table border=0 cellspacing=0 cellpadding=0 width=100%  bgcolor=#FFFFFF height=22 >';
strFrame+='          <tr bgcolor="#FAFAFA"><td id=bUseTimeLayer width=30  style="cursor:hand" title="点击这里启用/禁用时间"';
strFrame+='    onmouseover="style.backgroundColor=\'#aaccf3\'" align=center onmouseout="style.backgroundColor=\'#FAFAFA\'"';
...
strFrame+=' onmouseover="style.backgroundColor=\'#aaccf3\'" onmouseout="style.backgroundColor=\'#FAFAFA\'"';
